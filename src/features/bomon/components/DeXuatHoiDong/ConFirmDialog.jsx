      ...
      <div className="fixed left-130 w-2/7 h-1/3 bg-white z-5 rounded-xl">
        <div className="p-4 md:p-5 text-center">
          ...
          <div className="flex justify-center gap-4 mt-10 ml-13">
            <button className="text-white bg-red-700 hover:bg-red-800 focus:ring-1 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center  flex-3" onClick={onConfirm}>Xóa</button>
