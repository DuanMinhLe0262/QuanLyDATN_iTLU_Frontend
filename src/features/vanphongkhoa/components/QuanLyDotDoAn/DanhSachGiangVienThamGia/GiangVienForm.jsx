        ...
        <form className="max-w-md mx-auto" onSubmit={onSubmit}>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-3">
              <label htmlFor="hoDem" className="block text-sm/6 font-medium text-gray-900">Họ</label>
              <div className="mt-2">
                <input
                  type="text"
                  name="hoDem"
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-3">
              <label htmlFor="maGiangVien" className="block text-sm/6 font-medium text-gray-900">Mã giảng viên</label>
              <div className="mt-2">
                <input
                  type="text"
                  name="maGiangVien"
            ...
            <div className="sm:col-span-3">
              <label htmlFor="tenBoMon" className="block text-sm/6 font-medium text-gray-900">Bộ môn</label>
              <div className="mt-2 grid grid-cols-1">
                <select
                  ...
                  {danhSachBoMon.map((boMon) => (
                    <option key={boMon.id} value={boMon.tenBoMon}>
                      {boMon.tenBoMon}
                    </option>
                  ))}
                </select>
