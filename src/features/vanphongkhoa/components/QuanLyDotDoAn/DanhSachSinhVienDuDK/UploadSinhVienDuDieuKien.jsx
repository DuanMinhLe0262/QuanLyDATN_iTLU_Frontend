...
const UploadSinhVienDuDieuKien = ({ onCancel, onSuccessUpload  }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await sinhVienDotService.uploadExcel(file);
    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center">
      ...
      <div className="relative w-3/5 h-4/5 bg-white rounded-xl z-50 p-6 overflow-y-auto shadow-lg">
        ...
        <h1 className="font-bold text-3xl mb-10 mt-10">
          Tải lên danh sách sinh viên đủ điều kiện
        </h1>

        <div className="flex items-center gap-6 text-blue-600 text-sm mb-10">
          <a
            href="/FormSinhVienDuDK.xlsx"
            download
...
export default UploadSinhVienDuDieuKien;
